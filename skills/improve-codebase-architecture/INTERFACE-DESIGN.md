...
**Clean Code Alignment**: Direct the sub-agents to adhere to the "Deep Modules vs. Classic Clean Code" synthesis in [LANGUAGE.md](LANGUAGE.md). Specifically, they must design interfaces that eliminate temporal coupling and provide absolute clarity on mutability and side effects.
